...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      car_funds: {
        Row: { actual_monthly_payment: number; created_at: string; current_saved: number; down_payment_goal: number; expected_apr: number; id: string; interest_start_date: string | null; loan_amount: number; loan_start_date: string | null; loan_term_months: number; monthly_insurance: number; payment_start_date: string | null; phase: string; target_price: number; tax_fees: number; updated_at: string; user_id: string; vehicle_name: string }
        Insert: { actual_monthly_payment?: number; created_at?: string; current_saved?: number; down_payment_goal?: number; expected_apr?: number; id?: string; interest_start_date?: string | null; loan_amount?: number; loan_start_date?: string | null; loan_term_months?: number; monthly_insurance?: number; payment_start_date?: string | null; phase?: string; target_price?: number; tax_fees?: number; updated_at?: string; user_id: string; vehicle_name: string }
        Update: { actual_monthly_payment?: number; created_at?: string; current_saved?: number; down_payment_goal?: number; expected_apr?: number; id?: string; interest_start_date?: string | null; loan_amount?: number; loan_start_date?: string | null; loan_term_months?: number; monthly_insurance?: number; payment_start_date?: string | null; phase?: string; target_price?: number; tax_fees?: number; updated_at?: string; user_id?: string; vehicle_name?: string }
        Relationships: []
      }
      debts: {
      ...
      savings_goals: {
        Row: { contribution_start_date: string | null; created_at: string; current_amount: number; goal_type: string; id: string; linked_account: string | null; linked_rule_id: string | null; monthly_contribution: number; name: string; target_amount: number; target_date: string | null; updated_at: string; user_id: string }
        Insert: { contribution_start_date?: string | null; created_at?: string; current_amount?: number; goal_type?: string; id?: string; linked_account?: string | null; linked_rule_id?: string | null; monthly_contribution?: number; name: string; target_amount?: number; target_date?: string | null; updated_at?: string; user_id: string }
        Update: { contribution_start_date?: string | null; created_at?: string; current_amount?: number; goal_type?: string; id?: string; linked_account?: string | null; linked_rule_id?: string | null; monthly_contribution?: number; name?: string; target_amount?: number; target_date?: string | null; updated_at?: string; user_id?: string }
        Relationships: []
      }
      subscription_tiers: {
