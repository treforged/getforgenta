...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      car_funds: {
        Row: { actual_monthly_payment: number; created_at: string; current_saved: number; down_payment_goal: number; expected_apr: number; gift_contribution: number; id: string; interest_start_date: string | null; linked_account: string | null; linked_rule_id: string | null; loan_amount: number; loan_start_date: string | null; loan_term_months: number; monthly_insurance: number; payment_start_date: string | null; phase: string; planned_purchase_date: string | null; target_price: number; tax_fees: number; updated_at: string; user_id: string; vehicle_name: string }
        Insert: { actual_monthly_payment?: number; created_at?: string; current_saved?: number; down_payment_goal?: number; expected_apr?: number; gift_contribution?: number; id?: string; interest_start_date?: string | null; linked_account?: string | null; linked_rule_id?: string | null; loan_amount?: number; loan_start_date?: string | null; loan_term_months?: number; monthly_insurance?: number; payment_start_date?: string | null; phase?: string; planned_purchase_date?: string | null; target_price?: number; tax_fees?: number; updated_at?: string; user_id: string; vehicle_name: string }
