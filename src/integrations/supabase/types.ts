...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      recurring_rules: {
        Row: { active: boolean; amount: number; category: string; cost_type: string | null; created_at: string; deposit_account: string | null; due_day: number; due_month: number | null; end_date: string | null; frequency: string; id: string; name: string; notes: string | null; payment_source: string | null; rule_type: string; start_date: string | null; tax_rate: number | null; updated_at: string; user_id: string }
        Insert: { active?: boolean; amount?: number; category?: string; cost_type?: string | null; created_at?: string; deposit_account?: string | null; due_day?: number; due_month?: number | null; end_date?: string | null; frequency?: string; id?: string; name: string; notes?: string | null; payment_source?: string | null; rule_type?: string; start_date?: string | null; tax_rate?: number | null; updated_at?: string; user_id: string }
        Update: { active?: boolean; amount?: number; category?: string; cost_type?: string | null; created_at?: string; deposit_account?: string | null; due_day?: number; due_month?: number | null; end_date?: string | null; frequency?: string; id?: string; name?: string; notes?: string | null; payment_source?: string | null; rule_type?: string; start_date?: string | null; tax_rate?: number | null; updated_at?: string; user_id?: string }
        Relationships: []
      }
      savings_goals: {
        Row: { contribution_start_date: string | null; created_at: string; current_amount: number; goal_type: string; id: string; linked_account: string | null; linked_rule_id: string | null; lump_sum_payments: Json; monthly_contribution: number; name: string; target_amount: number; target_date: string | null; updated_at: string; user_id: string }
        Insert: { contribution_start_date?: string | null; created_at?: string; current_amount?: number; goal_type?: string; id?: string; linked_account?: string | null; linked_rule_id?: string | null; lump_sum_payments?: Json; monthly_contribution?: number; name: string; target_amount?: number; target_date?: string | null; updated_at?: string; user_id: string }
        Update: { contribution_start_date?: string | null; created_at?: string; current_amount?: number; goal_type?: string; id?: string; linked_account?: string | null; linked_rule_id?: string | null; lump_sum_payments?: Json; monthly_contribution?: number; name?: string; target_amount?: number; target_date?: string | null; updated_at?: string; user_id?: string }
        Relationships: []
      }
      subscription_tiers: {
