  ...
  return (
    <div className="space-y-8 text-sm">
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground leading-relaxed">
          TRE Forged LLC ("we", "us", "our") operates Forgenta, a personal finance management
      ...
      <section className="space-y-3">
        ...
        <div className="space-y-2 text-muted-foreground leading-relaxed">
          ...
          numbers, CVVs, or full payment details are ever stored by TRE Forged LLC.</p>
        </div>
      </section>
      ...
      <section className="space-y-3">
        ...
        <div className="space-y-2 text-muted-foreground leading-relaxed">
          ...
          web are processed by Stripe, Inc. via a Stripe-hosted checkout page. TRE Forged LLC never receives,
          ...
          purchased on iOS are billed directly by Apple, Inc. through the App Store. TRE Forged LLC does not
          ...
          purchased on Android are billed by Google LLC through Google Play. TRE Forged LLC does not receive
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground leading-relaxed">
          AI responses are generated by a third-party provider. TRE Forged LLC does not control the underlying
        ...
        <p className="text-muted-foreground leading-relaxed">
          ...
          AI chat history from your account at any time. TRE Forged LLC does not sell personal data, including
  ...
  return (
    <div className="space-y-8 text-sm">
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground leading-relaxed">
          By accessing or using Forgenta ("the Service"), provided by TRE Forged LLC
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground leading-relaxed">
          You retain full ownership of all financial data you enter into Forgenta. TRE Forged LLC does not
      ...
      <section className="space-y-3">
        ...
        <div className="space-y-2 text-muted-foreground leading-relaxed">
          ...
          <p>
            ...
            AI responses are generated by Google's Gemini 2.5 Flash model. TRE Forged LLC is not responsible
          ...
          <p>
            ...
            TRE Forged LLC may impose daily, weekly, or cost-based usage limits on AI Advisor to manage service
          ...
          <p>
            ...
            TRE Forged LLC reserves the right to limit, throttle, suspend, or permanently disable AI Advisor
