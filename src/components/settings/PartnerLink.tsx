      ...
      <div className="space-y-3">
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1 text-xs font-medium border border-border text-muted-foreground hover:border-destructive/40 hover:text-destructive-text transition-colors btn-press disabled:opacity-50 shrink-0 rounded-nested-2"
          >
